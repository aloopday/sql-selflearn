...
## Concatenate Columns
 ...
 - `LEFT(OUTER) JOIN`: Returns all records from the left tabler, and the matched records from the rifht table
 - `RIGHT (OUTER) JOIN`:Returns all records from the right table, and the matched records from the left table
 - `FULL(OUTER) JOIN`: Returns all records when there is a match in either lef or right table.
